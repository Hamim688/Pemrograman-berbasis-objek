...
import database # import modul databasse kita

class AnggaranHarian:
    """Mengelola logika bisnis pengeluaran harian (Repository Pattern)."""
    _db_setup_done = False # Flag unutk memastikan setup DB hanya dicek sekali persesi
    ...
    def __init__(self):
        ...
        if database.setup_database_initial(): # Panggil fungsi setup dari database.py
            ...
            print("[AnggranHarian] Database Siap.")
        else:
            print("[AnggranHariann] KRITICAL : Setup database awal GAGAL!")
    ...
    def get_semua_transkasi_obj(self) -> list[Transaksi]:
